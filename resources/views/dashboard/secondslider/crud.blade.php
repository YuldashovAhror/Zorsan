    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                {{-- @dd('asd') --}}
                <form action="{{ route('dashboard.secondslider.update', $secondslider) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
                    <div class="card-body">
                        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 text-center">
                                <img style="height: 150px; width: 150px"
                                    src="{{ $secondslider->photo2 }}">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="exampleFormControlInput1">Фото 2</label>
                                <div>
                                    <input class="form-control" id="exampleFormControlInput1" type="file" name="photo2"
                                        multiple>
                                </div>
                            </div>
                        </div>
